# Generated by Django 3.0.2 on 2020-04-23 11:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roles', models.ManyToManyField(blank=True, related_name='group_set', related_query_name='group', to='systems.Role', verbose_name='roles')),
            ],
            options={
                'verbose_name': '用户组',
